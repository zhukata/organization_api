...
Скрипт `check_functionality.py` выполняет автоматическое тестирование основных endpoint'ов API:

- Получение списка зданий
- Получение организаций по зданию
- Получение организаций по деятельности (включая дочерние)
- Получение организаций в радиусе от заданных координат
- Получение организации по ID
- Поиск организаций по названию

Скрипт использует базовую аутентификацию и проверяет корректность ответов API. При успешном выполнении всех проверок выводится сообщение "Все проверки пройдены успешно!".
